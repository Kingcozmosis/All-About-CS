...
class NewsCog(commands.Cog):
    ...
    # -------------------------
    @app_commands.command(name="dust2", description="Setup Dust2 news (Admin only)")
    async def dust2(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(embed=embed, view=Dust2SetupView(self))

    # -------------------------
    # Test command (Admin only)
    # -------------------------
    @app_commands.command(name="dust2_test", description="Test Dust2 news (Admin only)")
