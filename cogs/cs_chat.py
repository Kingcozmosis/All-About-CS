...
class CSSmartChatCog(commands.Cog):
    ...
    async def on_message(self, message: discord.Message):
        ...
        if self.bot.user in message.mentions:
            ...
            thinking = await message.channel.send("The AI is Thinking... If you feel information is false please refer to other / commands as the ai may be delulu")
...
"""
    ...
    async def handle_query(self, question):
        ...
        if not self.is_cs_question(question):
            ...
            return "I only answer Counter-Strike related questions. Try rewording or being more specific."
